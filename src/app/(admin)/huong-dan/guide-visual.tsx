...
function TenantVisual() {
  return <Box><div className="mb-2 flex items-center justify-between"><p className="font-semibold text-slate-800">Tạo hợp đồng mới</p><span className="rounded bg-brand-50 px-2 py-1 text-[9px] text-brand-700">Khách mới / khách đã có</span></div><div className="grid grid-cols-2 gap-1"><div className="rounded border border-slate-200 p-1.5">Họ và tên *</div><div className="rounded border border-slate-200 p-1.5">Số điện thoại</div><div className="rounded border border-slate-200 p-1.5">CCCD/CMND</div><div className="rounded border border-slate-200 p-1.5">Phòng trống *</div></div><div className="mt-2 rounded bg-brand-700 px-2 py-1 text-center font-semibold text-white">Lưu hợp đồng</div><p className="mt-1 text-[9px] text-slate-500">Không tạo bill, chưa ghi nhận thu cọc.</p></Box>;
}

function LeaseVisual() {
  return <Box><div className="mb-2 flex items-center justify-between"><p className="font-semibold text-slate-800">Hợp đồng</p><span className="rounded bg-slate-100 px-2 py-1 text-[9px] text-slate-500">Thao tác có xác nhận</span></div><div className="flex items-center justify-between rounded border border-slate-200 p-2"><div><p className="font-semibold">JA-201 · Hải Long - Tammie</p><p className="mt-1 text-[9px] text-slate-500">Đang thuê · 5.500.000/tháng</p></div><span className="rounded bg-sky-100 px-2 py-0.5 font-semibold text-sky-700">Đang thuê</span></div><div className="mt-2 rounded border border-amber-200 bg-amber-50 p-1.5 text-[9px] text-amber-800">Kết thúc chỉ khi đã xử lý bill và cọc.</div></Box>;
}
